...
import com.tmacsky.business.BusinessCategory;
import com.tmacsky.model.ModelCategory;
import com.tmacsky.utility.RegexTools;
	...
	implements android.view.View.OnClickListener
{
	...
	private void AddOrEditCategory() {
		...
		if(_Result)
		{
			Toast.makeText(getApplicationContext(), getString(R.string.TipsAddSucceed), Toast.LENGTH_LONG).show();
			finish();
		}
		else {
			Toast.makeText(getApplicationContext(), getString(R.string.TipsAddFail), Toast.LENGTH_LONG).show();
		}
	}
}
