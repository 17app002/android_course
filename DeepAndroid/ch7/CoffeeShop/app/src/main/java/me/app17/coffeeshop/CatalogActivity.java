...
public class CatalogActivity extends AppCompatActivity {
    ...
    public List<Item> getItemData(int catalog) {
        ...
        if (catalog == 0) {
            ...
            itemList.add(new Item(R.drawable.coffee_1, "芝麻抹茶那堤", "Sesame Green Tea Latte", 145,
                    "台灣在地開發飲品，秋季再次回歸，芝麻熟悉溫潤的香氣與抹茶優雅的滋味結合，" +
                            "迎合秋季淡雅風味的飲品，在品嘗間體會口中風味多層次的變化，芝麻與抹茶交織的美味。"));

            itemList.add(new Item(R.drawable.coffee_2, "摩卡可可碎片星冰樂", "Java Chip Frappuccino® Blended Beverage", 145,
                    "同樣為暢銷口味，結合星巴克咖啡、鮮奶、摩卡醬及可可碎片，以鮮奶油與摩卡醬裝飾，多層次口感及濃郁巧克力風味，獨具魅力。"));

            itemList.add(new Item(R.drawable.coffee_3, "香檸蜜柚冷萃咖啡", "Cold Brew Lemonade with Ruby \n" +
                    "Grapefruit and Honey", 135,
                    "檸檬清新的香氣，加入了紅柚醬與蜂蜜調和，更帶出冷萃咖啡本身的巧克力甘甜與柑橘的風味調性，讓柑橘類系風味完美的與咖啡結合，創造出平衡美妙的滋味。"));

            itemList.add(new Item(R.drawable.coffee_4, "香檸雙果紅茶汽滋樂", "Iced Shaken Mango Black Tea Lemonade Fizzio", 125,
                    "芒果富郁的果香、與清香的檸檬果汁和帶有淡淡花香的阿薩姆紅茶結合，打入氣泡後，一層層美妙的風味隨著氣泡冉冉上升，優雅卻暢快的滋味瞬間沁涼了炎炎的暑氣。\n" +
                            "限定門市銷售，請至星巴克網站門市專區-門市查詢\n" +
                            "實際供貨情況依各門市狀況會有不同，敬請見諒。"));

            itemList.add(new Item(R.drawable.coffee_5, "兒童熱可可", "Kid's Hot Chocolate", 95,
                    "濃郁香甜的巧克力風味，是小朋友的最愛。"));

            itemList.add(new Item(R.drawable.coffee_6, "金桔百香鮮果茶", "Kumquat & Passion Fruit Green Tea", 70,
                    "使用HPP技術，保留鮮果新鮮滋味\n" +
            ...
            itemList.add(new Item(R.drawable.dessert_2, "焙茶巧克力塔", "Hojicha Chocolate Tart", 230,
                    "於巧克力塔皮中夾入一層擂茶海綿蛋糕，灌入焙茶奶餡，上面淋上薄薄的巧克力淋面，整體散發茶香，並有巧克力尾韻，擁有美妙的層次風味變化。"));

            itemList.add(new Item(R.drawable.dessert_3, "燕麥奶生吐司", "Oat Milk Toast", 60,
                    "今年最夯的吐司非生吐司莫屬！麵糰經18小時低溫發酵，使用優質原料日本皇后牌麵粉及鐵塔奶油，再加入OATLY燕麥奶增添柔軟度及豐富膳食纖維，越嚼越香而且單吃就很好吃！"));

            itemList.add(new Item(R.drawable.dessert_4, "法式千層薄餅", "Mille Crêpes", 750,
                    "一片片輕薄Q彈的法式餅皮，搭配香氣迷人的香草卡士達餡；透過主廚輕柔手法，細心呵護的將每一層餅皮中裹上滑順的香草卡士達餡，交疊成美好的法式千層薄餅。"));

            itemList.add(new Item(R.drawable.dessert_5, "6\"Classic Cheese Cake", "6\"Classic Cheese Cake", 850,
